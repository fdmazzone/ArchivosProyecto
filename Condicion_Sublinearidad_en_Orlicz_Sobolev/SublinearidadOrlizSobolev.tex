...
Euler-Lagrange equations with sublinear pontentials   in an Orlicz-Sobolev space setting}



\author[unlpam]{S. ~Acinas \corref{corSonia}\fnref{fn1}}
\ead{sonia.acinas@gmail.com}

\author[unrc]{F. ~Mazzone \corref{corFer}\fnref{fn2}}
...
\fntext[fn1]{Instituto
 de Matem\'atica Aplicada San Luis (CONICET-UNSL)
,UNLPam}

\fntext[fn2]{CONICET,UNRC,UNLPam}
