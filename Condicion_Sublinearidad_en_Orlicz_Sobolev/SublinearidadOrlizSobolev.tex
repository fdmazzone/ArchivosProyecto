...
\end{equation}
 was studied in \cite{ABGMS2015}. It is interesting to note, regarding the condition \eqref{holder_cont}, that it is not difficult to prove this inequality is equivalent to the condition $\|F(t,\cdot)\|_{BO}\in L^1([0,T])$, where $\|\cdot\|_{BO}$ denotes the seminorm defined in  \cite[p. 125]{zhu2012analysis} on the space of functions of bounded variations. 
