...
\begin{defi} Let $\varphi_0:[0,+\infty)\to [0,+\infty)$ a function. We said that $G:[0,T]\times\rr^n\to\rr$  satisfies a \emph{grow conditions of  $\varphi_0$-type} if
\begin{equation}\label{holder_cont-mu}
  \left| G(t,x) \right|\leq b_1(t)\varphi_0(|x|)+b_2(t),
\end{equation}
...
\begin{thm}\label{coercitividad-r} Let $\Phi$ be a $N$-function whose complementary function $\Psi$ is $\Delta_2$-globally. We suppose that the $N$-function $\Phi_1$ satisfies \eqref{eq:caract_delta2}.  We assume that $F$ satisfies (C), (A) and a grow conditions of $\varphi_0$-type, where $\phi_0=\Phi_0'$ and $\Phi_0\llcurly\Phi_1$.  We assume the following conditions:
\begin{enumerate}
\item $\Psi\in\Delta_2$.
\item Inequality \eqref{holder_cont-mu}  $\varphi_0=\Phi'_0$ where $\Phi_0$ is a differentiable $N$-function that satisfies the $\Delta_2$-condition globally such that
