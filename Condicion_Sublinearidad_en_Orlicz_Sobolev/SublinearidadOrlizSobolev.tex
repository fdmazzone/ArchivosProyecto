...
The following lemma is essentially known, basically it is consequence of \cite[Prop. 4, p. 20]{rao1991theory} (we note that )

\newcommand{\complstronger}{\left|\prec\right.}
...
\Phi(rs)\geq \Phi^*(r)\Phi(s)\;\;\mbox{for every }r\geq1,s\geq 0\, (s\geq 1).
\end{equation}
\end{enumerate}
\end{lem}
