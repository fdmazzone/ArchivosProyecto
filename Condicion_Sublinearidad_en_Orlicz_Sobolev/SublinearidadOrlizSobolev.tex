...
Hence $u\in \wphiet\subset \domi$ is a minimun. Since $I$ is G\^ateaux differentiable on $\wphie$ (see  \cite[Th. 3.2]{ABGMS2015})
and therefore  $I'(u)\in (\wphiet)^{\perp}$. Finally,
