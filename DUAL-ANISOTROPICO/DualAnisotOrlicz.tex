...
\section{Optimal constant in Poincar\'e-Wirtinger inequality in $L^p$}
...
Then $u(0)=u(T)$, $u'(0)=u'(T)$ imply that the function has period T.
...
FALTA CHEQUEAR LO ESCRITO Y COMPARAR CON LO VISTO EN LA ULTIMA REUNIÓN.
