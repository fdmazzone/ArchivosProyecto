...
|D_s H(s,t)|&=\left| \nabla_x\mathcal{L}(t,u+sv,u'+sv')\cdot v +
 ...
 &\quad+ \lambda\lambda_v\left[\Psi\left(\frac{\nabla_y\mathcal{L}(t,u+sv,u'+sv')}{\lambda}\right)+\Phi\left(\frac{v'}{\lambda}\right) \right]
\\
...
\[
\begin{split}
\left\langle  I'(u_{n}),v \right\rangle &= \int_0^T \left\{  \nabla_x\mathcal{L}\left(t,u_n,u'_n\right)\cdot
v +
 \nabla_y\mathcal{L}\left(t,u_n,u'_n\right)\cdot v'\right\} \ dt\\
&\rightarrow \int_0^T \left\{ \nabla_x\mathcal{L}\left(t,u,u'\right)\cdot v+
\nabla_y\mathcal{L}\left(t,u,u'\right)\cdot v'\right\} \ dt\\
