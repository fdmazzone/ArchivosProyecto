...
\end{equation}
for every $|x|\geq M$. If $\Phi$ es a $\Delta_2$ function then $\Phi$ is bounded by powers functions (see \cite[Proof Lemma 2.4]{Desch2001}), i.e. there exists $1<p<\infty$, $C>0$ and $M\geq 0$ such that

\[\Phi(x)\leq C|x|^p,\quad |x|\geq  
