...
In order to find a modulus of continuity for functios in $\wphi$, and from there, to obtain compact embedding of $\whi$, we define the function $A_{\Phi}:\rr^+\to\rr^+$ by
