...
$\Phi:\mathbb{R}^d\to [0,+\infty)$ is of $N_{\infty}$ class if $\Phi$ is convex, $\Phi(0)=0$, $\Phi(x)>0$ if $x\neq 0$ and $\Phi(-y)=\Phi(y)$, 
 and 
...
$\Psi(\xi)\to \infty$  when $|\xi|\to \infty$,  see \cite[Section 4.2]{clarke2013functional},  \cite[Chapter 2]{mawhin2010critical}. Moreover $\Psi$ satisfies \eqref{eq:N-sub-inf} (see \cite[Th. 2.2]{Orliczvectorial2005}). i.e. $\Psi$ is $N_{\infty}$ function.
