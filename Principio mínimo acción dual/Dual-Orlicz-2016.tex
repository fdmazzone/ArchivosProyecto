...
\begin{split}
&\lambda \nabla_y\mathcal{L}(\cdot,u_{n_k},u'_{n_k})\ccdot \frac{v(t)}{\lambda} 
\\
&
\leq 
\lambda\left[\Psi(\nabla_y\mathcal{L}(\cdot,u_{n_k},u'_{n_k}))+\Phi\left(\frac{v}{\lambda}\right)\right]
\\
...
\int_0^T  \nabla_y\mathcal{L}(t,u_{n_k},u'_{n_k})
\ccdot  v \,dt 
\to 
