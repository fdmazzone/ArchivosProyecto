...
For simplicity, from now on we will consider Lagrangian functions of the form \eqref{eq:lagrange_phi}. However, the results of this section extend without difficulty to any lagrangian $\mathcal{L}$ with $\mathcal{L}\geq \mathcal{L}_{\Phi,F}$ (see \cite{ABGMS2015}).

\cite{tang1998periodic,wu1999periodic,zhao2004periodic}  \cite{tang2010periodic,
