...
In this section, we give a short introduction to n Orlicz and Orlicz-Sobolev spaces of vector valued functions (anisotropic Orlicz Spaces). References for  these topics are \cite{Orliczvectorial2005,Skaff1969, Desch2001}. The choice of anisotropic Orlicz-Sobolev spaces is justified since they allow to simplify the writing, and they provide the natural frame of statements of the type \cite[Lemma 3.1]{Tian2007192}.
...
Given a Young's function $\Phi$, we define the function $\hat{\Phi}}:\rr^+\to\rr^+$ by
\begin{equation}\label{eq:inversa-gral}
\hat{\Phi}(s)=\sup\{|x|:\Phi(x)\leq s\},
\end{equation}
