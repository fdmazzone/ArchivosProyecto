...
\end{lem}
\begin{proof}
 The space $E^{\Psi}([0,T],\rr^d)$ is separable (see \cite[Th. 6.3]{Orliczvectorial2005}).
...
\emph{Step 2. The action integral $I$ is sequentially weakly lower semicontinuous, i.e. if  $u_n'\rightharpoonup u'$ in the weak topology of $ \wphi([0,T],\rr^d)$ then
$
