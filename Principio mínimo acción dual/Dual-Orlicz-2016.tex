...
\emph{Step 2. $I$ is sequentially weakly
  lower semicontinuous} 

We assume that $u_n\rightharpoonup u $ in $\wphi([0,T],\rr^d)$. From the embedding $\lphi([0,T],\rr^d)\hookrightarrow L^1([0,T],\rr^d)$ we have the  $u_n'\rightharpoonup u' $ in $ L^1([0,T],\rr^d)$ and from 
