...
\begingroup%Locallizing the change to `thefootnote'.
    ...
    %}%
        \footnotetext{%
    \textbf{Keywords and phrases:} Periodic Solution, Orlicz-Sobolev Spaces, Euler-Lagrange, $N$-function, Critical Points.   
    }%
    \endgroup
%
%
...
\newblock {\em J. Abstr. Differ. Equ. Appl.}, 5(1):21--34, 2014.
...
\bibitem{cianchi2000fully}
A.~Cianchi.
\newblock A fully anisotropic {S}obolev inequality.
\newblock {\em Pacific J. Math.}, 196(2):283--295, 2000.

\bibitem{cianchi2000local}
A.~Cianchi.
\newblock Local boundedness of minimizers of anisotropic functionals.
\newblock {\em Ann. Inst. H. Poincar\'e Anal. Non Lin\'eaire}, 17(2):147--168,
  2000.

\bibitem{cianchi1999gradient}
A.~Cianchi and N.~Fusco.
\newblock Gradient regularity for minimizers under general growth conditions.
\newblock {\em J. Reine Angew. Math.}, 507:15--36, 1999.

\bibitem{claverooptimal}
N.~Clavero.
...
M.~M. Rao and Z.~D. Ren.
\newblock {\em Theory of {O}rlicz spaces}, volume 146 of {\em Monographs and
  Textbooks in Pure and Applied Mathematics}.
\newblock Marcel Dekker, Inc., New York, 1991.

\bibitem{2002applications}
M.~M. Rao and Z.~D. Ren.
\newblock {\em Applications of {O}rlicz spaces}, volume 250 of {\em Monographs
...
\bibitem{Orliczvectorial2005}
G.~Schappacher.
\newblock A notion of {O}rlicz spaces for vector valued functions.
\newblock {\em Appl. Math.}, 50(4):355--386, 2005.

\bibitem{struwe2008variational}
M.~Struwe.
