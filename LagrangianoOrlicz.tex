...
\end{split}
\end{equation}
 Invoking \eqref{DxL1}, \eqref{DyLpsi} with $ |\b{\dot{u}}|+s_0|\b{\dot{v}}|$ instead $\b{u}$ and taking account of $\b{\dot{v}}\in L^{\infty}$ and $\b{v}\in\lphi$ we show that there exists a function $g \in L^1([0,T], \mathbb{R}^{+})$
