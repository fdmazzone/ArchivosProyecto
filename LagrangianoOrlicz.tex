...
\section{Critical point of actions integrals}
...
\begin{defi} We said that a function $f: \mathbb{R}^n \to \mathbb{R}$ is \emph{strictly convex} if $f\left(\tfrac{x+y}{2}\right)< \tfrac{1}{2} \left(f\left( x\right)+f\left( y\right)\right)$.
\]
\end{defi}
