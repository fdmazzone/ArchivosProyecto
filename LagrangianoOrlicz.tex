...
We start for considering Lagrangians $\mathcal{L}:\rr\times\rr^n\to\rr^n$  satisfying 
\begin{equation}\label{reduc_lagran}
|\mathcal{L}(t,\b{y})|\leq b(t)+a_0\Phi\left(\frac{|\b{y}|}{\lambda}\right),
\end{equation}
with $a_0>0$ and $b\in L^1_1([0,T])$. The functionals induced by $\mathcal{L}$ were studied in the literature, see \cite[§17]{KR}.
