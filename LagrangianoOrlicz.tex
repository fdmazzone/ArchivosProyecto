...
\end{equation}
where $\alpha_0,\Lambda>0$ and  the function $F:\rr\times\rr^n\to\rr$ is measurable respect to $t$ for every fixed  $\b{x}\in\rr^n$ and continuous in $\b{x}$ for a.e. $t\in [0,T]$.
