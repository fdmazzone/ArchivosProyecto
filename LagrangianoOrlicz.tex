...
xu2007some,tang2010periodic,zhao2004periodic} ). In fact, conditions  \eqref{cotaL},\eqref{cotaDxL}, \eqref{cotaDyL} are equivalent to condition (A)  when  $\mathcal{L}(t,\b{x},\b{y})=\Phi_p(|\b{y}|)+F(t,\b{x})$, $\Phi_p(s)=s^p/p$,  and $d=0$. 
