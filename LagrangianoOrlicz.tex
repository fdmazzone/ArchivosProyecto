...
\]
 ...
 \begin{split}
  ...
  &=|D_xL(t,\xi_n(t),\dot{u}_n(t))||u_n(t)-u(t)|.
  \end{split}
 \end{equation}
...
\cite[Theorem 1.2]{mawhin2010critical}). We suppose that  $\|u_n- u\sobnor\to 0$. 

There exists $s=s_{n,t}\in[0,1]$
such that
\[|L(t,u(t),\dot{u}_n(t))-L(t,u(t),\dot{u}(t))|=|D_yL(t,u(t),(1-s)\dot{u}_n(t)+s \dot{u}(t))||u_n-u|.\]
Let $\mathfrak{G}$ be the set $\{|u_n(t)|\geq |u(t)|\}$. Then
...
\[\begin{split}|L(t,u(t),\dot{u}_n(t))-L(t,u(t),\dot{u}(t))|&\leq C\left(c(t)+\varphi(\chi_{\mathfrak{G}}|\dot{u}_n(t)|+
 ...
 $\lphi$ we have
 \[|H(u_n)-H(u)|\leq C\|u_n-u\orlnor\to 0.\]
 Which completes the proof ( sería feliz de creerlo )
 
Y, si ensayo con este programa
