...
\cite[Lemma 17.4]{KR} we have that $\{\Phi(v): \|v\|\leq r\}$ is bounded in $ L^1$ for any $r>0$. This fact implies that
...
\cite[Theorem 1.2]{mawhin2010critical}). We suppose that  $\|u_n- u\sobnor\to 0$. \textcolor{r}{Deber Fernando: v_n tiende a v}.
