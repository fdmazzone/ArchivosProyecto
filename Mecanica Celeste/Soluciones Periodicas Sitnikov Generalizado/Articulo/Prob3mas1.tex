...
\begin{theorem}\label{thm:prin_ine} We assume that $(q,m)$ is a admissible  configuration and the primaries are in a rigid motion. Every solution of \eqref{eq:eq_new_red} is of some of the following types:
\begin{enumerate}
