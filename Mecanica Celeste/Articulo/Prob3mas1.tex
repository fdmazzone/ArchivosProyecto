...
Let us to show a second proof of Theorem \ref{thm:prin_ine},  following arguments of \cite{zhao2015nonplanar} and \cite{li2013characterization}, based on variational principles and Sturm's comparison theorem.


\begin{proof}[Alternitave Proof Theorem \ref{thm:prin_ine}]   We consider the action integral
