...
The complementary function $\Phi^{\star}$ is an  $N_{\infty}$ function (see \cite[Ch. 2]{mawhin2010critical} and \cite[Thm. 2.2]{Orliczvectorial2005}).  The Moreau Theorem (see \cite[Thm. 4.21]{clarke2013functional}) implies that $\Phi^{\star\star}=\Phi$.
