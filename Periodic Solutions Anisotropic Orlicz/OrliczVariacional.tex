...
\begin{enumerate}
 ...
 \item[\namedlabel{eq:escalar_ine_2}{(P2)}] if $ 0<|\lambda_1|\leq |\lambda_2|, x\in\rr^d$, then $\Phi(\lambda_1 x)\leq\Phi(\lambda_2 x);$
...
\end{equation} 
Then, from the quasi-subadditivity of $\Phi^{\star}$ \ref{eq:quasi-sub-aditividad}, we get 
