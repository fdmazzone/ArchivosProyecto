...
Our approach involves the direct method of the calculus of variations in the framework of \emph{anisotropic Orlicz-Sobolev spaces}.  We will find solutions of \eqref{eq:ProbPhiLapla} for finding extreme points of the \emph{action integral} 
...
\section{Differentiability Gate\^aux of action integrals in anisotropic Orlicz spaces}\label{sec:diferenciabilidad}
